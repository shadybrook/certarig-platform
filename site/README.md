...
Public product page: the agent may ask, only the kernel may say yes, the zip is the proof. Paying customers: **zero**. Not a claim that an AI drives GPIO.
...
2. **Inlined single file** committed as `site/share.html`. Rebuild refreshes it.
