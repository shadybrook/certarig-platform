...
**Format:** Voiceover, illustrated stills, architecture cards, then a stitched product walkthrough. No talking-head required. Grammar inspired by the classmate Curastra demo, not copied from it.
...
## 11:00 to 11:40 — Future missions in the capstone

**Picture:** `stills/09_mission_1.png` through `stills/12_mission_4.png`, four seconds each, then `stills/13_missions_summary.png`.
...
**On screen:** `Four capstone missions. Authority stays with the kernel.`

---

## 11:40 to 12:10 — Phase 3 is complete

**Picture:** `stills/14_close.png`. Optional last frame: existing recorded red-to-green-to-red if you already have it. Do not recreate an energized sequence solely for this edit.
